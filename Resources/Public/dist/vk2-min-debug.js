...
function ff(a, b) {
  for (var c = 0;c < b.length;c++) {
    ...
    f.appendChild(h);
    h = "0" === e.get("denominator") || 0 === e.get("denominator") ? " unknown" : " 1:" + e.get("denominator");
    h = O("div", {"class":"scale", innerHTML:y.c("factory-scale") + h});
    f.appendChild(h);
...
;function sf(a, b, c) {
  ...
  c = "0" === c.denominator || 0 === c.denominator ? " unknown" : " 1:" + c.denominator;
