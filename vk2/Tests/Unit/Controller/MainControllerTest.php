...
/**
 * Test case for class SLUB\Vk2\Controller\MainController.
 *
...
class MainControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \SLUB\Vk2\Controller\MainController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('SLUB\\Vk2\\Controller\\MainController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function showActionAssignsTheGivenMainToView() {
		$main = new \SLUB\Vk2\Domain\Model\Main();
